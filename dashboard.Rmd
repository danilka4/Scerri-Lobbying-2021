...
yearly_sierra_joint <- plot_ly(
  ...
  node = list(
    label = labels_total,
    customdata = full_names(labels_total),
...
sierra_dead <- plot_ly(
  ...
  node = list(
    label = labs,
    customdata = full_names(labs),
    x = c(0, 0.23, 0.29, 0.5, 0.6, 0.75, 0.9, 1, 1),
...
return_sierra <- plot_ly(
  ...
  node = list(
    label = labs,
    customdata = full_names(labs),
    x = c(0.1, 0.23, 0.35, 0.5, 0.6, 0.7, 0.9),
...
return_year <- plot_ly(
  ...
  node = list(
    label = labs,
    customdata = full_names(labs),
    x = c(0.1, 0.23, 0.35, 0.5, 0.6, 0.72, 0.9),
    y = c(0.5, 0.5, 0.5, 0.29, 0.4, 0.5, 0.3),
    color = "gray",
    hovertemplate = node_hover,
    pad = 10), # 10 Pixel
...
The "joint" diagrams look at the specific committees that each bill goes through and separates the three that received the most amount of climate bills into separate nodes, so the reader can easily identify the most influential committees.
"Dead" graphs explicitly show the flow of dead bills from various parts of the political process in order to place an emphasis on the stages where the most amount of bills die.
Oftentimes, bills will be passed onto the second house, which reviews the bill and returns it to the previous house;
or the governor can also return the bill with recommendations, and that is what a "return sankey" highlights.
It shows the flow of returned bills from chamber 2 to chamber 1, and from the governor back to both chambers before the bills possibly become a law.
This highlights the potential complications that can appear within a bill's life cycle that show that there is more under the hood to an otherwise "uneventful" year demonstrated by other diagrams.
...
plot_ly(
  ...
  node = list(
    label = labels_15,
    customdata = full_names(labels_15),
    x = c(0, 0.2, 0.2, 0.2, 0.2, 0.35, 0.5, 0.5, 0.5, 0.5, 0.65, 0.75, 0.85, 1),
    y = c(0, -0.2, 0.20, 0.40, 0.8, 0.5, -0.2, 0.2, 0.4, 0.8, 0.5, 0.52, 0.5, 0.5),
    color = "gray",
    hovertemplate = node_hover,
    thickness = 10,
    pad = 10), # 10 Pixel
...
plot_ly(
  ...
  node = list(
    label = labs_dead,
    customdata = full_names(labs_dead),
...
plot_ly(
  ...
  node = list(
    label = labels_16,
    customdata = full_names(labels_16),
    x = c(0, 0.2, 0.2, 0.2, 0.2, 0.35, 0.5, 0.5, 0.5, 0.5, 0.65, 0.75, 0.85, 1),
...
We start off in 2016 with a republican-controlled state congress and a democratic governor.
...
plot_ly(
  ...
  node = list(
    label = labels_17,
    customdata = full_names(labels_17),
    x = c(0, 0.2, 0.2, 0.2, 0.2, 0.35, 0.5, 0.5, 0.5, 0.5, 0.65, 0.75, 0.85, 1),
    y = c(0, -0.2, 0.20, 0.40, 0.8, 0.5, -0.2, 0.2, 0.4, 0.8, 0.5, 0.5, 0.5, 0.5),
    color = "gray",
    hovertemplate = node_hover,
...
plot_ly(
  ...
  node = list(
    label = labels_18,
    customdata = full_names(labels_18),
    x = c(0, 0.2, 0.2, 0.2, 0.2, 0.35, 0.5, 0.5, 0.5, 0.5, 0.65, 0.75, 0.85, 1),
...
plot_ly(
  ...
  node = list(
    label = labs,
    customdata = full_names(labs),
    x = c(0.1, 0.23, 0.3, 0.4, 0.6, 0.75, 0.9, 1, 1),
...
plot_ly(
  ...
  node = list(
    label = labels_19,
    customdata = full_names(labels_19),
    x = c(0, 0.2, 0.2, 0.2, 0.2, 0.35, 0.5, 0.5, 0.5, 0.5, 0.65, 0.75, 0.85, 1),
    y = c(0, -0.2, 0.20, 0.40, 0.8, 0.5, -0.2, 0.2, 0.4, 0.8, 0.5, 0.5, 0.5, 0.5),
    color = "gray",
    hovertemplate = node_hover,
...
plot_ly(
  ...
  node = list(
    label = labels_20,
    customdata = full_names(labels_20),
    x = c(0, 0.2, 0.2, 0.2, 0.2, 0.35, 0.5, 0.5, 0.5, 0.5, 0.65, 0.75, 0.85, 1),
    y = c(0, -0.2, 0.20, 0.40, 0.8, 0.5, -0.2, 0.2, 0.4, 0.8, 0.5, 0.55, 0.5, 0.5),
    color = "gray",
    hovertemplate = node_hover,
...
plot_ly(
  ...
  node = list(
    label = labs,
    customdata = full_names(labs),
    x = c(0.1, 0.23, 0.35, 0.5, 0.6, 0.75, 0.9, 1, 1),
    y = c(0.3, 0.62, 0.28, 0.36, 0.23, 0.27, -0.05, -0.2, 0.7),
    color = "gray",
    hovertemplate = node_hover,
    pad = 10), # 10 Pixel
  link = list(
...
plot_ly(
  ...
  node = list(
    label = labels_21,
    customdata = full_names(labels_21),
    x = c(0, 0.2, 0.2, 0.2, 0.2, 0.35, 0.5, 0.5, 0.5, 0.5, 0.65, 0.75, 0.85, 1),
...
plot_ly(
  ...
  node = list(
    label = labs,
    customdata = full_names(labs),
    x = c(0.1, 0.23, 0.35, 0.45, 0.6, 0.75, 0.9, 1, 1),
